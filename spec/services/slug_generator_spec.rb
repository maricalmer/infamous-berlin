...
RSpec.describe Services::SlugGenerator do
  ...
  describe "assign_slug" do
    it "generates slug from user instance and username" do
      Services::SlugGenerator.new(string: first_user.username, client: first_user).assign_slug
      expect(first_user.slug).to eq(first_user.username)
    end
    it "generates slug from project instance and title" do
      Services::SlugGenerator.new(string: first_project.title, client: first_project).assign_slug
    ...
    it "generates different slug from project instance and title if slug already exists" do
      ...
      Services::SlugGenerator.new(string: second_project.title, client: second_project).assign_slug
    ...
    it "generates different slug from user instance and username if slug already exists" do
      ...
      Services::SlugGenerator.new(string: second_user.username, client: second_user).assign_slug
  ...
  describe "update_slug" do
    it "updates the slug if project gets updated" do
      ...
      Services::SlugGenerator.new(string: first_project.title, client: first_project).update_slug
      expect(first_project.slug).to eq("new_title")
    end
    it "updates the slug if user gets updated" do
      first_user.username = "new_username"
      Services::SlugGenerator.new(string: first_user.username, client: first_user).update_slug
